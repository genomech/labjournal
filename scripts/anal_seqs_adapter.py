...
def thread0(filename):
	...
	output_dir = blister_dir("/dev/datasets/FairWind/_results/dangl_adapt", create=True)
...
input_filenames = blister_input(["/dev/datasets/FairWind/_results/dangl/s7_FR_RF_0_R*.fastq.gz"])
