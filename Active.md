...
* выбрать только те риды, которые содержат illumina, взять их долю за 100%, пересчитать исходя из этого все полученные проценты и сделать новую таблицу? 
Или, если так будет проще, то можно взять обрезанные риды с длиной <149 и составить для них ещё раз анализ паттерна, уже отдельно от всех остальных.
